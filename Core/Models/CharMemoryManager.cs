...
public class CharMemoryManager : IVirtualMemoryManager<string>
{
    ...
    public CharMemoryManager(int bufferSize, string filename, int stringLength, int pageSize = DefaultPageSize)
    {
        if (bufferSize <= 0)
